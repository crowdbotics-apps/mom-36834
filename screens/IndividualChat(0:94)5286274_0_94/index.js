  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_0_792}>
        ...
        <View style={styles.View_0_818}>
          ...
          <ImageBackground
            source={{
              uri:
                "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/667d6b16-c49d-4389-9599-3006d64ad48e"
            }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/1e4f5c4b-1254-4ac8-addd-152c76ed59af"
        }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/c8334f7a-ad7b-4b87-b799-36208d9f005c"
        }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/b651216a-6bb7-447c-a301-5e99d62d3807"
        }}
        ...
        <View style={styles.View_I0_785_0_588}>
          ...
          >
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/db0af512-858f-4273-ab91-11a106cf4836"
              }}
          ...
          >
            <View style={styles.View_I0_785_0_628}>
              <ImageBackground
                source={{
                  uri:
                    "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/75b2f103-ac6d-4603-b929-4a24ab0e9b7b"
                }}
          ...
          >
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/255bc3ff-2725-44ce-92e1-e25b46336117"
              }}
        ...
        <View style={styles.View_I0_780_0_49}>
          <View style={styles.View_I0_780_0_51}>
            ...
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/8cec947b-f030-4665-b770-481ee5ddda8f"
              }}
          ...
          <View style={styles.View_I0_780_0_55}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/e2def247-eeca-446e-a867-17c1bb5a8136"
              }}
          ...
          <View style={styles.View_I0_780_0_60}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/52273a30-7e89-4335-bf06-0fa2c47cc2e5"
              }}
